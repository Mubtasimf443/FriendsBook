...
function socketMiddlewares(socket, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let verificationRasult = yield verifiyToken({ profileType, token });
...
function socketMiddlewaresVideoProfile(socket, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = socket.handshake.auth.token;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (profileType === 'matrimonyProfile') {
                let user = yield AuthSession_1.default.findOne({ key: token, expiration_date: { $gt: new Date() } }, 'value').lean();
                if (!user) {
