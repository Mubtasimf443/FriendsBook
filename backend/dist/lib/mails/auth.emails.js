...
function registrationOtpEmail(otp, email) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        `;
            const info = yield transporter_1.default.sendMail({
...
function registrationSuccessEmail(email) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const content = `
        <div style="background-color: ${env_1.EMAIL_BACKGROUND_COLOR}; padding: 20px;">
...
function forgotPasswordOtpEmail(otp, email) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const content = `
        <div style="background-color: ${env_1.EMAIL_BACKGROUND_COLOR}; padding: 20px;">
