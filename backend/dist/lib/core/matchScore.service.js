...
class MatchScoreService {
    ...
    static calculateLocationScore(user1, user2) {
        ...
        if (loc1.country !== loc2.country)
            return 0.3;
        if (((_a = loc1.division) === null || _a === void 0 ? void 0 : _a.id) === ((_b = loc2.division) === null || _b === void 0 ? void 0 : _b.id))
            return 1;
        if (((_c = loc1.district) === null || _c === void 0 ? void 0 : _c.id) === ((_d = loc2.district) === null || _d === void 0 ? void 0 : _d.id))
            return 0.8;
        return 0.5;
    }
    static calculateReligionScore(user1, user2) {
        ...
        if (user1.religion !== user2.religion)
            return 0;
        if (((_a = user1.aboutMe) === null || _a === void 0 ? void 0 : _a.religiousBranch) === ((_b = user2.aboutMe) === null || _b === void 0 ? void 0 : _b.religiousBranch))
            return 1;
        return 0.7;
    }
    ...
    static calculateOccupationScore(user1, user2) {
        ...
        if (!user1.occupation || !user2.occupation)
            return 0.5;
        const pref1 = ((_a = user1.partnerPreference.profession) === null || _a === void 0 ? void 0 : _a.acceptedOccupations) || [];
        const pref2 = ((_b = user2.partnerPreference.profession) === null || _b === void 0 ? void 0 : _b.acceptedOccupations) || [];
    ...
    static getHighestEducation(user) {
        var _a;
        if (!((_a = user.education) === null || _a === void 0 ? void 0 : _a.length))
    ...
    static meetsBasicCriteria(user, criteria) {
        ...
        return user.age >= criteria.ageRange.min &&
            ...
            (!((_a = criteria.education) === null || _a === void 0 ? void 0 : _a.mustBeEducated) || user.isEducated);
    }
...
MatchScoreService.EDUCATION_LEVELS_ORDER = Object.values(userEducation_types_1.EducationLevel);
MatchScoreService.SCORE_WEIGHTS = {
