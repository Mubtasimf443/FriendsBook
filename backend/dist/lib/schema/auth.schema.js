...
exports.registrationUserSchema = zod_1.z.object({
    ...
    phoneInfo: zod_1.z.object({
        ...
        country: zod_1.z.object({
            ...
            phone_code: CountryPhoneCodeEnum
                .default(((_a = countryCodes_1.countryCodes.find(c => c.country === country_names_enum_1.CountryNamesEnum.BANGLADESH)) === null || _a === void 0 ? void 0 : _a.code) || '+88')
            ...
            return (countryCode === null || countryCode === void 0 ? void 0 : countryCode.code) === data.phone_code;
        }, {
    ...
    .refine(function (data) {
    var _a, _b;
    return ((_a = data.address.district) === null || _a === void 0 ? void 0 : _a.division_id) === ((_b = data.address.division) === null || _b === void 0 ? void 0 : _b.id);
}, {
    ...
    .refine(function (data) {
    var _a, _b;
    return ((_a = data.address.upazila) === null || _a === void 0 ? void 0 : _a.district_id) === ((_b = data.address.district) === null || _b === void 0 ? void 0 : _b.id);
}, {
    ...
    .refine(function (data) {
    var _a, _b;
    return ((_a = data.address.union) === null || _a === void 0 ? void 0 : _a.upazilla_id) === ((_b = data.address.upazila) === null || _b === void 0 ? void 0 : _b.id);
}, {
...
exports.LoginSchema = zod_1.z.object({
    ...
    .refine((data) => { var _a, _b; return !!data.email || (!!((_a = data.phoneInfo) === null || _a === void 0 ? void 0 : _a.number) || !!((_b = data === null || data === void 0 ? void 0 : data.phoneInfo) === null || _b === void 0 ? void 0 : _b.phone_code)); }, {
    ...
    if (data.loginType === LoginEnum.withPhone) {
        return !!((_a = data.phoneInfo) === null || _a === void 0 ? void 0 : _a.number) || !!((_b = data === null || data === void 0 ? void 0 : data.phoneInfo) === null || _b === void 0 ? void 0 : _b.phone_code);
    }
    return true;
}, {
