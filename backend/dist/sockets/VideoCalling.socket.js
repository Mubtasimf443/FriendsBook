...
function configureVideoCallingSocket(io) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            io.on('connection', (socket) => __awaiter(this, void 0, void 0, function* () {
                ...
                socket.on('init-call', (recieverId, peerId) => __awaiter(this, void 0, void 0, function* () {
                    try {
                        recieverId = schemaComponents_1._idValidator.parse(recieverId);
                        const min_calling_coin = 1200;
                        const sender = yield VideoProfile_1.default.findById(socket.user_id);
                        if (!sender)
                        ...
                        const reciever = yield VideoProfile_1.default.findById(recieverId);
                        if (!reciever)
                        ...
                        const existingCall = yield VideoCallingRoom_1.VideoRoom.findOne({
                            $or: [
                        ...
                        const room = yield VideoCallingRoom_1.VideoRoom.create({
                        ...
                        if (reciever.socket_ids.video_calling_socket) {
                            ...
                            setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                                const pendingRoom = yield VideoCallingRoom_1.VideoRoom.findOne({
                                    roomId: room.roomId,
                                    status: VideoCallingRoom_1.VideoCallStatus.PENDING
                                });
                                if (pendingRoom) {
                            ...
                            yield VideoCallingRoom_1.VideoRoom.findByIdAndUpdate(room._id, {
                ...
                socket.on('accapt-video-call-request', (_a) => __awaiter(this, [_a], void 0, function* ({ roomId, peerId }) {
                    try {
                        if (!roomId || !peerId)
                            return socket.emit('call-error', { message: 'Invalid request parameters' });
                        const room = yield VideoCallingRoom_1.VideoRoom.findOne({
                            roomId,
                        ...
                        yield VideoProfile_1.default.updateMany({ _id: { $in: [room.caller.user_id, room.reciever.user_id] } }, { status: 'busy' });
                ...
                socket.on('reject-video-call-request', (_a) => __awaiter(this, [_a], void 0, function* ({ roomId }) {
                    try {
                        if (!roomId)
                            return socket.emit('call-error', { message: 'Invalid request parameters' });
                        const room = yield VideoCallingRoom_1.VideoRoom.findOne({
                ...
                socket.on('calling-started', (_a) => __awaiter(this, [_a], void 0, function* ({ roomId }) {
                    try {
                        if (!roomId)
                            return socket.emit('call-error', { message: 'Invalid request parameters' });
                        const room = yield VideoCallingRoom_1.VideoRoom.findOne({
                ...
                socket.on('add-calling-duration', (_a) => __awaiter(this, [_a], void 0, function* ({ roomId, duration }) {
                    try {
                        ...
                        yield room.save();
                        const caller = yield VideoProfile_1.default.findById(room.caller.user_id);
                        if (caller) {
                            ...
                            if (caller.video_calling_coins <= 0) {
                                ...
                                yield VideoProfile_1.default.updateMany({ _id: { $in: [room.caller.user_id, room.reciever.user_id] } }, { status: 'online' });
                                return;
                            }
                            yield caller.save();
                        }
                ...
                socket.on('call-ended', (_a) => __awaiter(this, [_a], void 0, function* ({ roomId }) {
                    try {
                        if (!roomId)
                            return socket.emit('call-error', { message: 'Invalid request parameters' });
                        const room = yield VideoCallingRoom_1.VideoRoom.findOne({
