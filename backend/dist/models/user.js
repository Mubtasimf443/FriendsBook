...
const userSchema = new mongoose_1.Schema({
    ...
    annualIncome: {
        ...
        currency: {
            type: String,
            required() { var _a; return !!((_a = this.annualIncome) === null || _a === void 0 ? void 0 : _a.currency); },
            uppercase: true,
...
userSchema.methods.removeFCMToken = function () {
    return __awaiter(this, void 0, void 0, function* () {
...
userSchema.methods.createPreference = function () {
    ...
    const agePreferences = (() => {
        ...
        if (this.gender === user_types_1.Gender.MALE) {
            // For male users
            const minAge = Math.max(LEGAL_MIN_AGE_WOMEN, this.age - MAX_AGE_DIFFERENCE, Math.floor(this.age * 0.75) // Cultural norm: bride shouldn't be less than 3/4th of groom's age
            );
            const maxAge = Math.min(this.age - 2, // Cultural norm: bride usually younger
            CULTURAL_MAX_AGE_WOMEN, this.age + 3 // Rare but acceptable case
            );
            return { min: minAge, max: maxAge };
        }
        else {
            // For female users
            const minAge = Math.max(LEGAL_MIN_AGE_MEN, this.age, // Cultural norm: groom should not be younger
            Math.floor(this.age * 1.1) // Cultural norm: groom usually slightly older
            );
            const maxAge = Math.min(CULTURAL_MAX_AGE_MEN, this.age + MAX_AGE_DIFFERENCE, Math.ceil(this.age * 1.3) // Cultural norm: groom shouldn't be too old
            );
            return { min: minAge, max: maxAge };
        }
    })();
    ...
    const locationPreferences = (() => {
        ...
        if (isBangladeshi && ((_a = this.address.district) === null || _a === void 0 ? void 0 : _a.lat) && ((_b = this.address.district) === null || _b === void 0 ? void 0 : _b.long)) {
            ...
            return {
                ...
                preferredRegions: [(_c = this.address.division) === null || _c === void 0 ? void 0 : _c.id],
    ...
    const educationAndProfessionPreferences = (() => {
        ...
        const getEducationPreferences = () => {
            ...
            if (this.gender === user_types_1.Gender.FEMALE) {
                ...
                return {
                    minimumLevel: (userHighestEdu === null || userHighestEdu === void 0 ? void 0 : userHighestEdu.level) || user_types_1.EducationLevel.BACHELORS_DEGREE,
                    mustBeEducated: true,
        ...
        const getMinimumIncomePreference = () => {
            var _a;
            if (!((_a = this.annualIncome) === null || _a === void 0 ? void 0 : _a.amount))
                return undefined;
            return {
                min: this.gender === user_types_1.Gender.FEMALE
    ...
    const weightPreferences = (() => {
        ...
        const calculateBMI = (weight) => weight / (heightInMeters * heightInMeters);
        ...
        return {
            min: this.gender === user_types_1.Gender.MALE ? minWeight : Math.max(40, this.weight - 10),
            max: this.gender === user_types_1.Gender.MALE ? Math.min(this.weight + 5, maxWeight) : Math.min(this.weight + 15, maxWeight)
        };
    })();
    this.partnerPreference = Object.assign(Object.assign({ ageRange: agePreferences, heightRange: heightPreferences, weightRange: weightPreferences, maritalStatus: [
            user_types_1.MaritalStatus.NEVER_MARRIED,
            ...(this.maritalStatus !== user_types_1.MaritalStatus.NEVER_MARRIED ?
                [this.maritalStatus] : [])
        ], complexion: Object.values(partnerPreference_1.ComplexionPreference).filter(c => c !== partnerPreference_1.ComplexionPreference.ANY), physicalStatus: [userProfile_types_1.PhysicalStatus.NORMAL], religiousBranch: ((_a = this.aboutMe) === null || _a === void 0 ? void 0 : _a.religiousBranch) ? [this.aboutMe.religiousBranch] : undefined, dealBreakers: [userProfile_types_1.BadHabits.SMOKING, userProfile_types_1.BadHabits.DRINKING], locationPreference: locationPreferences }, educationAndProfessionPreferences), { religion: [this.religion], motherTongue: this.languages.slice(0, 1), familyValues: [partnerPreference_1.FamilyValues.TRADITIONAL, partnerPreference_1.FamilyValues.MODERATE], familyBackground: this.familyInfo ? {
        ...
        } : undefined, strictPreferences: this.gender === user_types_1.Gender.FEMALE, priority: {
...
userSchema.methods.createMID = function () {
    return (0, mid_geneator_1.default)(this.address.country);
};
