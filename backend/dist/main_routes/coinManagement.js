...
router.post('/buy-coins/paypal', auth_middleware_1.validateVideoProfile, function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let pAccessToken = yield paypal.getAccessToken();
            let paymentInfo = yield paypal.createPayment({
...
router.post('/buy-coins/stripe', auth_middleware_1.validateVideoProfile, function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let packageIdValidation = zod_1.z.enum(['package_1', 'package_2', 'package_3', 'package_4']);
            let package_id = packageIdValidation.parse(req.body.package_id);
            ...
            let paymentInfo = yield stripe.checkOut({
                shipping_amount: 0,
                line_items: [
                    {
                        price_data: {
...
router.get('/payment-success/paypal', function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const accessToken = yield paypal.getAccessToken();
            const paymentDetails = yield paypal.captureDetails(token);
...
router.get('/payment-success/stripe', function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const session = yield stripe.retrieveSession(sessionId);
