...
router.post('/create-expenses', auth_middleware_1.validateVideoProfile, function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let user = yield VideoProfile_1.default.findById(req.videoProfile._id);
            if (!user)
            ...
            yield user.save();
            yield CoinExpense_1.CoinExpense.create({
                coins,
                expense_type,
...
router.get('/history/:type', auth_middleware_1.validateVideoProfile, function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let expenses = yield CoinExpense_1.CoinExpense.find(base_query).sort({ expending_date: -1 });
