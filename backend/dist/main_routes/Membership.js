...
router.get('/membership-history', function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b;
        try {
            ...
            console.error('[Get Membership History API Error]', {
                ...
                userId: (_b = (_a = req.authSession) === null || _a === void 0 ? void 0 : _a.value) === null || _b === void 0 ? void 0 : _b.userId
            });
...
router.post('/membership-request', function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const existingPendingRequest = yield membershipRequest_1.MembershipRequest.findOne({
                requesterID: userId,
...
router.put('/membership-request/cancel', function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let { token, session } = yield (0, giveBearerTokenAndSession_1.default)(req);
            if (!session) {
